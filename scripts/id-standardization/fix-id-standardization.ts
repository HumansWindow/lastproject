...
// Define EntityIssue type structure as a JSDoc comment instead of TypeScript interface
/**
 * @typedef {Object} EntityIssue
 ...
 * @property {string} [code] - Optional fixed code
 */
